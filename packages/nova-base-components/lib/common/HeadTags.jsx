...
class HeadTags extends Component {
    render() {
        ...
        const YOUR_APPLICATION_ID = "bAWPW8Ap8Sbk6prAu8hflEoDZ5uCvjTvY5nLpB7X";
        const YOUR_CLIENT_KEY = "IVBFiLf7PZ8m2pvQBKoxFz7uxdFJ7wlZ6vJUP1Ia";
        const parse_initialize = 'Parse.initialize("' + YOUR_APPLICATION_ID + '","' + YOUR_CLIENT_KEY + '");';

        const script = Telescope.headtags.script.concat(
          [
              {"src": "http://fb.me/react-0.13.3.min.js", "type": "text/javascript"},
              {"src": "https://www.parsecdn.com/js/parse-react.js", "type": "text/javascript"},
              {innerHTML: parse_initialize}
          ]);
